...
export function commandeValideeTemplate({
  client,
  jeu,
  offre,
  montant,
  ...
  return `
    ...
    <head>
      ...
      <title>Commande validée - NovaLoot</title>
    </head>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:16px;border:1px solid #e5e7eb;padding:40px;">
              ...
              <tr>
                <td style="padding:30px 0;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f0fdf4;border-radius:12px;border:1px solid #86efac;padding:20px;margin:0 0 24px 0;">
                    <tr>
                      ...
                      <td style="padding:4px 0;">
                        <table width="100%" cellpadding="4" cellspacing="0">
                          ...
                          <tr>
                            ...
                            <td style="color:#16a34a;font-size:14px;font-weight:600;">✅ Validée</td>
                          </tr>
                        </table>
                      </td>
                    </tr>
